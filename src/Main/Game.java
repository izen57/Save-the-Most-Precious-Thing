...
/**
 * This class is the whole structure of the game.
 */
public class Game {
    ...
    /**
     * Initialize the elements in the game, such as user and NPC{@link Character},
     * different locations{@link Location} and items{@link AbstractItem}.
     */
    ...
    /**
     * Start the main plot of the game.
     * In addition to the main loop, there are also pre- and post-plots to improve the completion of the game.
     */
    public void startGame() {
        ...
        while(true) {// Start an infinite loop
            System.out.print("> ");
            String input0 = scanner.nextLine().toLowerCase();// Read user input

            if (input0.equalsIgnoreCase("ready")) {// check user input
                System.out.println(
                ...
                );//print message if input is correct and jump out of the loop
                ...
                // go back to top of the loop until the input is correct
            }
        }
        ...
        while (true) {
            ...
            if (inputA.contains("read")) {
                ...
                System.out.println("While you were immersed in the scenery, you received a message on your phone...");
            }
        }
        ...
        while (true) {
            System.out.print("> ");
            String inputD = scanner.nextLine().toLowerCase();
