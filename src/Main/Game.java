                ...
                case "ancientGreekStair":
                    ...
                    while (true) {
                        ...
                        if (inputF.contains("right")) {
                            ...
                            System.out.println(
                                "You have returned to the corridor filled with ancient Greek sculptures, " +
                                "on your right is the statue of Venus with a broken arm. " +
                                "She stands at the end of the corridor, facing the corridor, " +
                                "silently watching the countless secular people passing by."
                            );
                ...
                case "frenchPaintingCollections":
                    ...
                    while (true) {
                            ...
                            if (inputJ.contains("back") || inputJ.contains("leave") || inputJ.contains("return")) {
                                ...
                                System.out.println("In the corner of the hall you can see a shelf with booklets about the history of the hall.\n");
...
//        //if user answer no: she will ask you for help in reverse and lend u the key to open the gate of room which keeps the monalisa
        ...
        while(true) {
            ...
            if (inputN.contains("yes")) {
                ...
                System.out.println(
                    "Okay, can you do me a favor? I'm going to get something from the basement. " +
                    "This is the key to Monalisa's room. Can you help me bring it in?"
                );
                System.out.println(
                    "You take the key from her, now it seems like you can open the door now. " +
                    "Meanwhile, there are some small words on the key."
                );
