    ...
    public void startGame() {
        ...
        while(true){
            ...
            if(input0.equalsIgnoreCase("ready")){
                ...
                System.out.println("This is a text adventure game set in the Louvre Museum in Paris, France. You need to enter the correct answer to advance the plot or location. The correct answer does not exceed two words, and is often a noun, a verb, or a combination of a verb and a noun.\n" +
                        "At the same time, pay attention to the items that appear in the scene. When you pick up the item, some items will enter your inventory and some will not. For item in inventory, you can drop it and the item will be removed from the inventory.\n" +
                        "\n" +
        ...
        do{ try {
            ...
            //asked ChatGPT for this detection
                ...
                throw new IllegalArgumentException("in this game, all correct answers consist of only words," +
        ...
        while (true) {
            ...
            if (inputM.contains("talk") || inputM.contains("ask")) {
                ...
                System.out.println("It is better not to do anything weird " +
        ...
        while (true) {
            ...
            if (inputN.contains("yes")) {
                System.out.println("Hey, I don't know you, you're not a museum member here, " +
